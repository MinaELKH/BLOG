...
use  ModelsReservation\Vehicule ; 
use  ModelsReservation\Categorie ; 
use  ModelsReservation\Reservation ; 
use  ModelsReservation\Client ; 
...
<header class="bg-gray-900 bg-opacity-95 py-2">
    ...
    <main>
        <section>
                ...
                <form id="filterForm" class="flex flex-wrap items-center gap-6">
                    ...
                    <div class="flex flex-col">
                        ...
                        <select name="categorie" class="border p-2">
                            <option value="" enabled>catégorie</option>
                            <?php
                    ...
                    <!-- Bouton de recherche -->
                    <div class="flex flex-col justify-end"> <!-- Label invisible pour garder l'alignement -->
                        <label class="invisible">Mot clé</label>
                        <button type="submit" name="btn_filter" value="btn_filter" class="bg-primary-500 hover:bg-primary-600 inline-block px-6 py-2 text-center text-white">
                            Recherche
                        </button>
                    </div>
            ...
            <div id="vehiculesContainer" class="grid grid-cols-3 gap-4">
