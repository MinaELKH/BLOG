...
if (isset($_POST["deleteComment"])) {
    $newFav = new Favorite($dbManager, intval($_POST['id_favoris']));
    $newFav->delete();
}
?>
<html lang="en">
                ...
                <div class="grid grid-cols-1   md:grid-cols-2 gap-4  lg:grid-cols-2 ">
                    ...
                    function showArticle($result)
                    {
                        ...
                        foreach ($result as $objetA) {
                            echo '
           <article class="max-w-sm bg-white rounded-lg shadow-md overflow-hidden">
                ...
                <div class="relative">
                    ...
                    <div class="p-4">
                        ...
                        <div class="flex items-center justify-between text-gray-500 text-xs mb-4">
                            ...
                            <div class="flex space-x-4">
                              ...
                              if (isset($result[0]) && !empty($result[0]->name)) {
                                 ...
                                 echo'  <input type="hidden" value="' . $objetA->id_favorite . '">
                        ...
                        <div class="flex space-x-2">';
                            ...
                            $newtag = new ArticleTags($dbManager, $objetA->id_article);
